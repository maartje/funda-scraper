...
class FundaSoldSpider(CrawlSpider):
    ...
    def parse_details(self, response):
        ...
        new_item['woonoppervlakte_text'] = self.extract_text(response, "/th[contains(.,'Woonoppervlakte')]/following-sibling::td[1]/span/text()")

        new_item['kamers_text'] = self.extract_text(response, "/th[contains(.,'Aantal kamers')]/following-sibling::td[1]/span/text()")

        new_item['status'] =  self.extract_text(response, "/th[contains(.,'Status')]/following-sibling::td[1]/span/text()")
        ...
        new_item['soort_bouw'] =  self.extract_text(response, "/th[contains(.,'Soort bouw')]/following-sibling::td[1]/span/text()")
        ...
        new_item['garage'] =  self.extract_text(response, "/th[contains(.,'Soort garage')]/following-sibling::td[1]/span/text()")
